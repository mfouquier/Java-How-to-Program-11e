...
//Instance variables to define the sides of the tetrahedron
	private double side1; 
	private double side2;
	private double side3;
//Constructor
	public Tetrahedron(double side1, double side2, double side3) {
		super(side1, side2, side3);
		this.side1 = side1;
		this.side2 = side2;
		this.side3 = side3;
	}
//SET and GET methods for sides 1, 2, 3 of the tetrahedron
...
/**Overrides abstract method getArea from abstract class ThreeDimensional
	and is specific for the area of a Tetrahedron*/
	@Override
	public double getArea() {
		return Math.sqrt(3) * Math.pow(getSide1(), 2);
	}
/**Overrides abstract method getVolume from abstract class ThreeDimensional
* and is specific for the area of a Tetrahedron*/
	@Override
	public double getVolume() {
		return Math.pow(getSide1(), 3) / (6 * Math.sqrt(2));
	}
